...
export const Todolist: FC<TodolistPropsType> = memo(({ id }) => {
  const dispatch = useAppDispatch()
  let todolist = useSelector<AppRootStateType, TodolistDomainType>(
    state => state.todolists.filter(tl => tl.id === id)[0]
  )
  ...
  const callBackHandlerForUpdateTitle = useCallback(
    (title: string) => {
